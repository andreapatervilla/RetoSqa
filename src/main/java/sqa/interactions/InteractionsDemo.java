...
public class InteractionsDemo implements Interaction {
    @Override
    ...
    public static InteractionsDemo on(){
        return Instrumented.instanceOf(InteractionsDemo.class).withProperties();
    }
}